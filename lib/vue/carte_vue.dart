...
class CarteVue extends StatefulWidget {
  ...
  CarteVue({Key? key , required CartePres cartePres}) : _cartePres = cartePres , super(key: key){
    _listTableRow = List.generate(Carte.taille, (y) => TableRow(children:

    List.generate( Carte.taille, (x) => AspectRatio(aspectRatio: 1, child: Image.asset(_cartePres.getPathElementTerrainFromCoord(y: y, x: x))
