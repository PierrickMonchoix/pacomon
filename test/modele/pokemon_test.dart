...
void main() {
  testWidgets('pokemon get random', (tester) async {
    Pacomon salameche = Pacomon(nom: "Salameche", pathImage: "path_salameche", rarete: 1, atk: 0, def: 0, pv: 0 , categorie: "DEBUT", exp : 10);
    Pacomon rien = Pacomon(nom: "rien", pathImage: "path_rien", rarete: 0, atk: 0, def: 0, pv: 0 , categorie: "DEBUT", exp : 10);
    Pacomon dracofeu = Pacomon(nom: "Dracofeu", pathImage: "path_dracofeu", rarete: 1, atk: 0, def: 0, pv: 0 ,categorie: "HARD", exp : 10);
